...
@Component({
  selector: 'app-strength-static-load-record-list',
  templateUrl: './strength-static-load-record-list.component.html',
  styles: [
  ]
})
export class StrengthStaticLoadRecordListComponent extends ReportListComponent implements OnInit {
  schema: SFSchema = {
    properties: {
      deviceRecordUuid: {
        type: 'string',
  ...
  constructor(public deviceRecordService: DeviceRecordService, public strengthStaticLoadRecordService: StrengthStaticLoadRecordService, public router: Router,
    ...
    super(servicePathService.strengthStaticLoadRecord, strengthStaticLoadRecordService, modal, cdr, router, deviceRecordService );
  ...
  deviceRecordProcess(successData, failureData) {
    super.deviceRecordProcess(this.schema, this.columns, successData, failureData, 'strengthStaticLoadRecord', this.strengthStaticLoadRecordService.listPropertys);
  }
  ngOnInit(): void {
  }
